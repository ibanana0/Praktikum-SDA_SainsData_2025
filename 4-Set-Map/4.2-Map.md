...
Map (atau **pemetaan**) adalah struktur data yang menyimpan pasangan **key-value** (*kunci-nilai*), di mana setiap **key** bersifat unik dan digunakan untuk mengakses **value** yang dipetakan padanya. Map sering digunakan untuk menggantikan metode pengaksesan elemen menggunakan indeks dari yang biasanya menggunakan Integer menjadi bisa menggunakan Key dengan tipe data sesuai kebutuhan. Hal ini dapat memudahkan metode pengaksesan elemen.
